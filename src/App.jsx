...
const CATEGORIAS = {
  ...
  despesa: ["Habitação", "Alimentação", "Transporte", "Saúde", "Lazer", "Bebé", "Animais", "Outros"],
};
...
const LISTA_PRODUTOS = {
  ...
  "🍞 Padaria & Cereais": ["Pão de forma","Pão de mistura","Pão integral","Papo-secos","Croissants","Tostas","Tortilhas trigo","Bolachas de água e sal","Bolachas Maria","Bolachas de aveia","Cereais de pequeno-almoço","Muesli","Aveia","Flocos de milho","Granola"],
  ...
  "🥦 Legumes & Verduras": ["Batatas","Batata-doce","Cebolas","Alho","Cenouras","Tomates","Tomate cherry","Alface","Salada","Espinafres","Couve portuguesa","Couve-flor","Brócolos","Courgette","Beringela","Pimentos","Pepinos","Alho francês","Nabo","Aipo","Ervilhas","Feijão verde","Cogumelos","Abóbora","Salsa","Coentros"],
  "🍎 Frutas": ["Maçãs","Peras","Laranjas","Tangerinas","Limões","Bananas","Uvas","Morangos","Melão","Melancia","Ananás","Kiwis","Pêssegos","Nectarinas","Ameixas","Cerejas","Mirtilos","Manga","Abacate","Romã","Figos"],
  "🥫 Mercearia & Conservas": ["Azeite","Óleo alimentar","Vinagre","Vinagre balsâmico","Sal","Açúcar","Mel","Farinha de trigo","Farinha de milho","Maizena","Fermento","Arroz agulha","Arroz carolino","Massa esparguete","Massa penne","Massa fusilli","Massa lasanha","Feijão enlatado","Grão enlatado","Lentilhas","Tomate triturado","Polpa de tomate","Caldo de galinha","Caldo de carne","Leite de coco","Molho de tomate","Ketchup","Mostarda","Maionese","Molho de soja","Tabasco","Sementes sésamo","Sementes chia"],
  ...
  "🧁 Doces & Snacks": ["Chocolate negro","Chocolate de leite","Chocolate branco","Bolachas chocolate","Biscoitos","Croissants embalados","Batatas fritas","Pipocas","Barras de cereais","Frutos secos","Amêndoas","Nozes","Cajus","Castanhas-do-Brasil","Passas","Gomas","Rebuçados"],
  "🧴 Higiene Pessoal": ["Sabonete","Gel de banho","Champô","Amaciador cabelo","Condicionador","Pasta de dentes","Escova de dentes","Fio dentário","Elixir bucal","Desodorizante","Creme hidratante","Creme de mãos","Protetor solar","Maquinilha de barbear","Espuma de barbear","Creme depilatório","Pensos higiénicos","Tampões","Preservativos","Fraldas","Fraldas Tamanho 2","Toalhetes bebé"],
  "🧹 Limpeza da Casa": ["Detergente roupa líquido","Detergente roupa pó","Amaciador roupa","Detergente louça","Detergente máquina louça","Sal máquina louça","Brilhante máquina louça","Limpador multiusos","Limpador casa banho","Limpador cozinha","Limpador vidros","Lixívia","Desinfetante","Pastilhas sanita","Gel sanita","Ambientador spray","Ambientador elétrico","Sacos do lixo","Esponjas","Esfregão","Pano microfibra","Luvas borracha","Toalhitas superfícies"],
  "🧻 Papel & Descartáveis": ["Papel higiénico","Papel de cozinha","Lenços de papel","Guardanapos","Papel de alumínio","Papel vegetal","Película aderente","Sacos congelar","Sacos para sandes","Copos descartáveis","Pratos descartáveis","Palhinhas","Toalhitas WC"],
  "💊 Farmácia & Saúde": ["Paracetamol","Ibuprofeno","Aspirina","Antigripal","Xarope tosse","Descongestionante nasal","Vitamina C","Vitamina D","Magnésio","Probióticos","Pensos rápidos","Água oxigenada","Álcool 70%","Termómetro","Solução salina nasal","Soro fisiológico","Compressas"],
